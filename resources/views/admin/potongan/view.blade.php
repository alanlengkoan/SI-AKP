            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        {{ Breadcrumbs::render('admin.potongan') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered" id="tabel-potongan-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
...
<div id="modal-add-upd" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="{{ route('admin.potongan.save') }}" method="POST">
                <!-- begin:: id -->
                ...
                <div class="modal-body">
                    ...
                    <div id="form-show">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama potongan" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control inputNumber" name="persen" id="persen" placeholder="Masukkan presentase potongan" />
                                <span class="errorInput"></span>
                            </div>
                        </div>
                        <div class="form-group row">
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-potongan-dt').DataTable({
            serverSide: true,
            responsive: true,
            processing: true,
            ...
            ajax: "{{ route('admin.potongan.get_data_dt') }}",
            columns: [{
                    title: 'No.',
                    data: 'DT_RowIndex',
                    class: 'text-center'
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <button type="button" id="upd" data-id="` + full.id_potongan + `" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-add-upd" data-backdrop="static" data-keyboard="false"><i class="fa fa-edit"></i>&nbsp;Ubah</button>&nbsp;
                            <button type="button" id="del" data-id="` + full.id_potongan + `" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;Hapus</button>
                        `;
                    },
                },
            ],
        ...
        $(document).on('click', '#upd', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#persen').val((response.persen * 100));
