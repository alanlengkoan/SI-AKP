...
<div id="modal-add-upd" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="{{ route('admin.agama.save') }}" method="POST">
                <!-- begin:: id -->
                ...
                <div class="modal-body">
                    ...
                    <div id="form-show">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama agama" />
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-agama-dt').DataTable({
            ...
            ajax: "{{ route('admin.agama.get_data_dt') }}",
            columns: [{
                    title: 'No.',
                    data: 'DT_RowIndex',
                    class: 'text-center'
