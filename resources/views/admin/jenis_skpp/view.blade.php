            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        {{ Breadcrumbs::render('admin.jenis_skpp') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered" id="tabel-jenis-skpp-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
...
<div id="modal-add-upd" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="{{ route('admin.jenis_skpp.save') }}" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="id_jenis_skpp" id="id_jenis_skpp" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    ...
                    <div id="form-show">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="kode" id="kode" placeholder="Masukkan kode skpp" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan nama skpp" />
                                <span class="errorInput"></span>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-jenis-skpp-dt').DataTable({
            serverSide: true,
            responsive: true,
            processing: true,
            ...
            ajax: "{{ route('admin.jenis_skpp.get_data_dt') }}",
            columns: [{
                    title: 'No.',
                    data: 'DT_RowIndex',
                    class: 'text-center'
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <button type="button" id="upd" data-id="` + full.id_jenis_skpp + `" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-add-upd" data-backdrop="static" data-keyboard="false"><i class="fa fa-edit"></i>&nbsp;Ubah</button>&nbsp;
                            <button type="button" id="del" data-id="` + full.id_jenis_skpp + `" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;Hapus</button>
                        `;
                    },
                },
            ],
    ...
    let untukTambahData = function() {
        $(document).on('click', '#add', function(e) {
            ...
            $('#id_jenis_skpp').removeAttr('value');
    ...
    let untukUbahData = function() {
        $(document).on('click', '#upd', function(e) {
            ...
            $.ajax({
                type: 'GET',
                dataType: 'json',
                url: "{{ route('admin.jenis_skpp.get') }}",
                data: {
                    id: ini.data('id')
                },
                beforeSend: function() {
                ...
                success: function(response) {
                    ...
                    $('#id_jenis_skpp').val(response.id_jenis_skpp);
        ...
        $(document).on('click', '#del', function() {
            ...
            swal({
                ...
                if (del) {
                    $.ajax({
                        type: "post",
                        url: "{{ route('admin.jenis_skpp.del') }}",
                        dataType: 'json',
                        data: {
                            id: ini.data('id'),
                        },
