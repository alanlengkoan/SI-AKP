            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        {{ Breadcrumbs::render('admin.ampra_gaji.det', $ampra_gaji) }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-right">
                            <a href="{{ route('admin.kartu_gaji.print', my_encrypt($ampra_gaji->id_ampra_gaji)) }}" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-print"></i>&nbsp;Cetak SKPP</a>&nbsp;
                            <a href="{{ route('admin.kartu_gaji', my_encrypt($ampra_gaji->id_ampra_gaji)) }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;Tambah Pengembalian Gaji Pokok</a>&nbsp;
                            <a href="{{ route('admin.pengembalian', my_encrypt($ampra_gaji->id_ampra_gaji)) }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;Tambah Pengembalian Lainnya</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
