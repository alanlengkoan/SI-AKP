            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        {{ Breadcrumbs::render('admin.ampra_gaji.upd') }}
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form id="form-add-upd" action="{{ route('admin.ampra_gaji.save') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="no_surat" id="no_surat" placeholder="Nomor Surat" value="{{ $ampra_gaji->no_surat }}" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" name="tgl_surat" id="tgl_surat" placeholder="Nomor Surat" value="{{ $ampra_gaji->tgl_surat }}" />
                                    <span class="errorInput"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_pegawai" id="id_pegawai">
                                        ...
                                        <option value="{{ $item->id_pegawai }}" {{ $ampra_gaji->id_pegawai == $item->id_pegawai ? 'selected' : '' }}>{{ $item->nip }} - {{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    <span class="errorInput"></span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="id_ttd" id="id_ttd">
                                        <option value=""></option>
                                        @foreach($ttd as $item)
                                        <option value="{{ $item->id_ttd }}" {{ $ampra_gaji->id_ttd == $item->id_ttd ? 'selected' : '' }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                    <span class="errorInput"></span>
                                </div>
