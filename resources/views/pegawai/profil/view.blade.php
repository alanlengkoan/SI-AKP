                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="form-foto" action="{{ route('pegawai.profil.save_picture') }}" method="POST">
                                    <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body border-top pro-det-edit collapse " id="pro-det-edit-2">
                                <form id="form-akun" action="{{ route('pegawai.profil.save_account') }}" method="POST">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label font-weight-bolder">Nama&nbsp;*</label>
                                        <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="form-keamanan" action="{{ route('pegawai.profil.save_security') }}" method="POST">
                                    <div class="form-group row">
