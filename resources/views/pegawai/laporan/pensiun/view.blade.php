...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered" id="tabel-pensiun-aktif-dt" style="width: 100%;">
                </table>
            </div>
        </div>
    </div>
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-pensiun-aktif-dt').DataTable({
            serverSide: true,
            responsive: true,
            processing: true,
            autoWidth: false,
            ...
            ajax: {
                url: "{{ route('pegawai.laporan.pensiun.get_data_dt') }}",
                type: "post",
                data: function(d) {
                    d._token = "{{ csrf_token() }}";
                    d.status = '0';
