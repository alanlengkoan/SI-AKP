...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered" id="tabel-pangkat-aktif-dt" style="width: 100%;">
                </table>
            </div>
        </div>
    </div>
...
<script>
    ...
    let untukTabel = function() {
        table = $('#tabel-pangkat-aktif-dt').DataTable({
            serverSide: true,
            responsive: true,
            processing: true,
            autoWidth: false,
            ...
            ajax: {
                url: "{{ route('pegawai.laporan.pangkat.get_data_dt') }}",
                type: "post",
                data: function(d) {
                    d._token = "{{ csrf_token() }}";
                    d.status = '1';
