            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        {{ Breadcrumbs::render('operator.profil') }}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="form-foto" action="{{ route('operator.profil.save_picture') }}" method="POST">
                                            <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body border-top pro-det-edit collapse " id="pro-det-edit-2">
                                        <form id="form-akun" action="{{ route('operator.profil.save_account') }}" method="POST">
                                            <div class="form-group row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="form-keamanan" action="{{ route('operator.profil.save_security') }}" method="POST">
                                            <div class="form-group row">
