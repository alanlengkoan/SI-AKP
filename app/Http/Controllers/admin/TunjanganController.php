...
class TunjanganController extends Controller
{
    ...
    {
        return Template::load($this->session['roles'], 'Tunjangan', 'tunjangan', 'view');
    }

    public function get(Request $request)
    {
        $response = Tunjangan::find($request->id);
    ...
    {
        $response = Tunjangan::select('id_tunjangan AS id', 'nama AS text')->orderBy('id_tunjangan', 'desc')->get();
    ...
    {
        $data = Tunjangan::orderBy('id_tunjangan', 'desc')->get();
